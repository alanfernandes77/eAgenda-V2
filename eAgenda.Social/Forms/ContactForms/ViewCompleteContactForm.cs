...
{
    public partial class ViewCompleteContactForm : Form
    {
        private readonly ContactRepository _contactRepository;
        private readonly ContactsControl _contactsTableControl;
        private readonly Contact _selectedContact;
        public ViewCompleteContactForm(ContactRepository contactRepository, ContactsControl contactsTableControl)
        {
        ...
        private void LoadElements()
        {
            ...
            LblContactCompany.Text = _selectedContact.Company;
            LblContactJobPosition.Text = _selectedContact.Job;
            ChbContactHasCompany.Checked = true;
            ChbContactHasCompany.Enabled = false;
        }
